...
public final class DiscloseDtos {
  ...
  public record DisclosePage<T>(
      Integer totalResults, Integer pageSize, Integer page, List<T> results, List<PageUrl> url) {}
  ...
  @JsonIgnoreProperties(ignoreUnknown = true)
  public record FundSummary(String fundNumber, String fundName, String fundStatus) {}
  ...
  public record InvestmentMixItem(
      String investmentType, String targetPercentageOrRange, BigDecimal actualPercentage) {}

  @JsonIgnoreProperties(ignoreUnknown = true)
  public record TopTenInvestment(
      String assetName, BigDecimal assetProportion, String assetType, String assetCountry) {}
