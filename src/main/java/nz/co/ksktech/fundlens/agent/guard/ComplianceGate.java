...
/**
 * Fail-safe wrapper around the ComplianceAgent: any malformed LLM output,
 * parse failure or upstream error maps to BLOCK — a compliance check can
 * never throw to the client and never silently passes.
 */
@ApplicationScoped
