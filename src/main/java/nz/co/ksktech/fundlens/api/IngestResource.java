...
public class IngestResource {
    ...
    public static class IngestForm {
        ...
        @RestForm
        @NotBlank
        @Pattern(regexp = "FUND_UPDATE|PDS|FACT_SHEET|OTHER",
    ...
    @Operation(summary = "Upload and ingest a fund document (PDF or text)",
    ...
    public IngestResponse ingest(@Valid @BeanParam IngestForm form) {
        ...
        FundDocument document = ingestionService.ingest(data, fileName,
